...
categoriesRoutes.post("/", (req, res) => {
    ...
    const createCategoryService = new CreateCategoryService(categoriesRepository); // Aqui foi criado um objeto e instanciado e passado o (categoriesRepository).

    createCategoryService.execute({name, description}); // Aqui está sendo chamado o método execute() ad classe (CreateCategoryService) da pasta services.
